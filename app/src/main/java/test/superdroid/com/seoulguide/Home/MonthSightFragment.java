...
public class MonthSightFragment extends Fragment {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                for (int i = 0; i < ja.length(); i++) {
                    ...
                    Log.d("LOG/HomeMonth", "get SightInfo : " + sightInfo.getName() + ", Ranking : " + sightInfo.getRank());
                }
    ...
    private class BitmapConverter extends AsyncTask<Object, Object, Object> {
        ...
        protected void onProgressUpdate(Object... values) {
            ...
            Log.d("LOG/HomeMonth", "get Bitmap : " + sightInfo.getName()  + ", Ranking : " + sightInfo.getRank());
        }
    }
}
